...
const addIngredient = (req, res) => {
  pool.getConnection((err, db) => {
    ...
    db.query(
      `INSERT INTO ingredient_t (ingredient, restaurant_name, price_adjust) VALUES (?, ?, ?)`,
...
const addToping = (req, res) => {
  pool.getConnection((err, db) => {
    ...
    const price = parseInt(req.body.price);
    db.query(
      `INSERT INTO toping_t (toping, restaurant_name, price_adjust) VALUES (?, ?, ?)`,
...
const addMenu = (req, res) => {
  pool.getConnection((err, db) => {
    ...
    db.query(
      `INSERT INTO menu_t (menu_name, restaurant_name, price, picture) VALUES (?, ?, ?, ?)`,
...
const addToCategory = (req, res) => {
  pool.getConnection((err, db) => {
    ...
    db.query(
      `INSERT INTO category_t (menu_name, category) VALUES (?, ?)`,
      [menu_name, category],
      (err, result) => {
        if (err) {
          db.release();
